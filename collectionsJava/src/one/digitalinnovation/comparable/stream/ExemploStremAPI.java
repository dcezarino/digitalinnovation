...
public class ExemploStremAPI {
	...
	public static void main(String[] args) {
		...
		// cada nome
		System.out.println("Retorna uma nova coleção com a quantidade de letra: " + estudantes.stream()
		...
		System.out.println("Todos os elementos com letra W no nome? "
